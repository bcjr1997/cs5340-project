...
class VAE(nn.Module):
    def __init__(self, image_dim, input_channels=1, latent_dim=256):
        ...
        self.decoder_l2 = nn.Sequential(nn.ConvTranspose2d(32 * 8, 32 * 4, kernel_size=4, stride=2, padding=1), nn.ReLU())
        ...
        self.decoder_l4 = nn.Sequential(nn.ConvTranspose2d(32 * 2, 32, kernel_size=4, stride=2, padding=1), nn.ReLU())
        self.decoder_l5 = nn.Sequential(nn.ConvTranspose2d(32, input_channels, kernel_size=4, stride=2, padding=1), nn.Sigmoid())
    ...
    def forward(self, x):
        ...
        dec_l4 = self.decoder_l4(dec_l3)
        dec_l5 = self.decoder_l5(dec_l4)
