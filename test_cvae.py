...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_path', type=str, default=os.path.join('model_outputs', 'cvae', 'test'))

    # Training Configuration
    parser.add_argument('--model_weights', type=str, default=os.path.join('model_outputs', 'cvae', 'model_weights', 'cvae_weights_1.pth'))
