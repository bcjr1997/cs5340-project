...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_weights_path', type=str, default=os.path.join('mc_dropout', 'model_outputs', 'vae'))
    parser.add_argument('--save_path', type=str, default=os.path.join('denoised_outputs', 'vae'))
