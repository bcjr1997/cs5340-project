...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights_path', type=str, default=os.path.join('deep_ensembles', 'model_outputs', 'vae'))
    parser.add_argument('--save_path', type=str, default=os.path.join('deep_ensembles', 'ensemble_model_outputs', 'vae'))
